    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        <p className="text-xl mt-5">
          ...
          improving my skills. The languages  i have learnt are the following : html ,css,  javascript, react.js for front end. Python, Mongodb , Nodejs , Expressjs ionic angular typescript 
        ...
        <p className="text-xl">
         ...
         where i worked on doing desgin briefs and  dashboard administration.
          ...
          UCpro where i worked as a  front end developer for  1 year  working 
         ...
         Lavalamp labs where I have worked there for 1 year using tech such as ionic angular and typscrpit to build mobile applications 
        </p>
      </div>
    </div>
  );
